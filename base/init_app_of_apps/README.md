...
| repourl_configuration | string | `"https://github.com/mcapala/openshift-clusterconfig"` | The repourl_configuration parameter specifies the URL of the Git repository containing cluster configurations. |
...
spec:
  ...
  project: default
  sources:
    - repoURL: https://github.com/mcapala/openshift-clusterconfig
      targetRevision: main
      ref: values
...
This Application will observe https://github.com/mcapala/openshift-clusterconfig for any changes.
...
Source code: https://github.com/mcapala/openshift-clusterconfig/tree/main/base/init_app_of_apps
